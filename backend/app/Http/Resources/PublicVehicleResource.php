...
class PublicVehicleResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'daily_rate_driver'           => $this->daily_rate_driver !== null ? (float) $this->daily_rate_driver : null,
            'daily_rate_driver_formatted' => $this->daily_rate_driver !== null ? 'Rp ' . number_format((float) $this->daily_rate_driver, 0, ',', '.') : null,
            'has_driver_option'           => !empty($this->daily_rate_driver) && (float) $this->daily_rate_driver > 0,
            'status'               => $this->status,

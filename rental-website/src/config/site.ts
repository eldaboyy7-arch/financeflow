export const siteConfig = {
  ...
  apiUrl: (import.meta.env.VITE_PUBLIC_FLEET_API_URL as string) || '/api/public/fleet',
  tourPackagesApiUrl: (import.meta.env.VITE_PUBLIC_TOUR_PACKAGES_API_URL as string) || '/api/public/tour-packages',
}

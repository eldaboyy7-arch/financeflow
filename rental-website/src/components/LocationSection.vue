    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="max-w-3xl mb-10">
        ...
        <p class="text-sm sm:text-base text-slate-600 mt-2 leading-relaxed">
          Siap antar-jemput armada di bandara, pelabuhan ferry, hotel, atau lokasi pilihan Anda di Bintan &amp; Tanjungpinang.
        </p>
      </div>
          ...
          <div class="lg:col-span-6 flex flex-col justify-between h-full">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-3 pt-4 border-t border-slate-100">
              <a
                ...
                class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-slate-300 hover:bg-slate-50 text-slate-700 text-xs font-semibold transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold transition-colors shadow-xs"
              >

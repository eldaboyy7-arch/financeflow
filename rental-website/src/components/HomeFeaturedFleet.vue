          ...
          <div class="p-2.5 sm:p-5 flex flex-col justify-between flex-1">
            ...
            <div class="mt-2 sm:mt-4 pt-2 border-t border-slate-100">
              ...
              <div
                ...
                class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-blue-50 border border-blue-200/60 text-blue-700 text-[10px] font-bold mb-2"
              >
              ...
              <div
                v-else
                class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-slate-100 border border-slate-200/60 text-slate-700 text-[10px] font-semibold mb-2"
              >

        ...
        <div v-reveal:fade-right class="lg:w-72 xl:w-80 shrink-0 mb-6 lg:mb-0 lg:pt-1">
          ...
          <div class="hidden lg:block text-xs text-slate-500 space-y-2">
            <p class="flex items-start gap-2">
              ...
              <span>{{ t('tripInspirations.customRoute') }}</span>
            </p>
            <div class="flex gap-3 pt-1">
              <RouterLink to="/armada" class="font-semibold text-blue-600 hover:underline text-xs">{{ t('tripInspirations.allFleet') }}</RouterLink>
              <RouterLink to="/paket-tour-bintan" class="font-semibold text-blue-600 hover:underline text-xs">{{ t('tripInspirations.hiacePkg') }}</RouterLink>
            </div>
          </div>
        </div>
